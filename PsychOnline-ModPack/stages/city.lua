...
function onCreate()
	-- -- background shit
	makeLuaSprite('sky', 'BG_Sol_1', -1000, -425);

	if not lowQuality then
		makeLuaSprite('bgCity', 'BG_Sol_2', -1000, -425);
	end

	makeLuaSprite('ground', 'BG_Sol_3', -1000, -425);
	makeLuaSprite('limo', 'BG_Sol_Limo', 0, 300);

	if not lowQuality then
		makeAnimatedLuaSprite('agoti', 'Agoti_Beat_Glow', 1190, 330);
		makeAnimatedLuaSprite('aldryx', 'Aldryx_Beat_Glow', 1740, 270);
